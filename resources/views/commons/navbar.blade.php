                    ...
                    @if(Auth::check())
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="mr-3 img-responsive" src="{{ Gravatar::src(Auth::user()->email, 20) }}" alt="Generic placeholder image">{{ Auth::user()->name }}
                            </a>
                        ...
                        <li class="nav-item">
                            {!! link_to_route('users.index', 'Users', null, ['class' => 'nav-link']) !!}
                        </li>
